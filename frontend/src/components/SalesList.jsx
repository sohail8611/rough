...
export default function CustomizedTables(props) {
  ...
  async function fetchData() {
    ...
    if (
      ...
      await axios
        .get(theurl)
        .then((res) => {data = res.data.myData; response = res.data.success;})
    ...
    {
      await axios
        .get(nodejsip + "/terminals" + "/terminal_search_pos/where/pos=/" + props.searchArray.POSType )
        .then((res) => {data = res.data.myData; response = res.data.success;})
        .catch((err) => console.log("therr", err));
      return { data, response };
    }
    ...
    {
      await axios
        .get(nodejsip + "/terminals" + "/terminal_search_product/where/product=/" + props.searchArray.Prod )
        .then((res) => {data = res.data.myData; response = res.data.success;})
        .catch((err) => console.log("therr", err));
      return { data, response };
    }
    ...
    {
      await axios
        .get(nodejsip + "/terminals" + "/terminal_search_terminalid/where/terminalid=/" + props.searchArray.TerminalID )
        .then((res) => {data = res.data.myData; response = res.data.success;})
        .catch((err) => console.log("therr", err));
      return { data, response };
    }
    ...
    {
      await axios
        .get(nodejsip + "/terminals" + "/terminal_search_merchantid/where/merchantid=/" + props.searchArray.MerchantID )
        .then((res) => {data = res.data.myData; response = res.data.success;})
        .catch((err) => console.log("therr", err));
      return { data, response };
    }
    ...
    {
      await axios
        .get(nodejsip + "/terminals" + "/terminal_search_merchantname/where/merchantname=/" + props.searchArray.MerchantListName )
        .then((res) => {data = res.data.myData; response = res.data.success;})
        .catch((err) => console.log("therr", err));
      return { data, response };
    }
