...
export default function CustomizedTables(props) {
  ...
  const [defaultSelectedZoneValue, setDefaultSelectedZoneValue] =
    React.useState("");
  const [defaultSelectedZoneID, setDefaultSelectedZoneID] =
    React.useState("");
  ...
  const handleSubmit = (event) => {
    ...
    let myurl =
      ...
      9999999999 +
      "/" +
      "nullSubZone"+",,,"+defaultSelectedZoneValue+"___"+defaultSelectedZoneID;
    axios
      .get(myurl)
      .then((res) => {
    ...
    let myurl =
      ...
      currentsubzone +
      "/" +
      defaultselectedsubzone+",,,"+defaultSelectedZoneValue+"___"+defaultSelectedZoneID;
    axios
      .get(myurl)
      .then((res) => {
        //  data = res.data.myData;
  ...
  async function fetchData(offset) {
    ...
    if (props.inputValue != "") {
      await axios
        .get(nodejsip + "/zones/searchzoneallLocations/where/zonename=/" + props.inputValue)
        .then((res) => {
          data = res.data.myData;
          setTableresponse(res.data.success);
        })
  ...
  async function callApi(offset) {
    ...
    setapiData(await fetchData(offset));
    // console.log(apiData);
  }
                            ...
                            <Row>
                                    ...
                                    <form onSubmit={handleSubmit}>
                                      ...
                                      <FormControl fullWidth>
                                        ...
                                        <TextField
                                          ...
                                          // required= "true "
                                          label="zone name"
                                          defaultValue={defaultSelectedZoneValue}
                                          onChange={(event) =>
                              ...
                              <div className="form-outline mb-4 col-lg-4">
                                <Button
                                  ...
                                  onClick={() => openPopup(row.subzoneID,row.zoneID)}
                                >
